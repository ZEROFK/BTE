...
static bool SelectBlockFromCandidates(vector<pair<int64_t, uint256> >& vSortedByTimestamp, boost::unordered_map<uint256, const CBlockIndex*, Uint256Hasher, Uint256Hasher>& mapSelectedBlocks,
...
bool ComputeNextStakeModifier(const CBlockIndex* pindexPrev, uint64_t& nStakeModifier, bool& fGeneratedStakeModifier)
{
    ...
    boost::unordered_map<uint256, const CBlockIndex*, Uint256Hasher, Uint256Hasher> mapSelectedBlocks;
